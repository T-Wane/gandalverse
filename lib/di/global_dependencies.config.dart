...
import 'package:gandalverse/core/providers/user_provider.dart' as _i6;
import 'package:gandalverse/core/repositories/user_repository.dart' as _i5;
...
import 'package:gandalverse/di/global_dependencies_module.dart' as _i7;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i5.UserRepository>(
        () => _i5.UserRepository(gh<_i4.TelegramCloudStorage>()));
    gh.singleton<_i6.UserProvider>(
        () => _i6.UserProvider(gh<_i5.UserRepository>()));
    return this;
  }
}

class _$GlobalDependenciesModule extends _i7.GlobalDependenciesModule {}
