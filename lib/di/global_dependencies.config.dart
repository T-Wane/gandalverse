...
import 'package:gandalverse/core/repositories/tabAndEarnRepository.dart' as _i9;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i8.UserProvider>(
        () => _i8.UserProvider(gh<_i7.UserRepository>()));
    gh.singleton<_i9.TapAndEarnRepository>(
        () => _i9.TapAndEarnRepository(gh<_i8.UserProvider>()));
    gh.lazySingleton<_i10.EquipeService>(
        () => _i10.EquipeService(gh<_i8.UserProvider>()));
    gh.lazySingleton<_i11.PartenaireService>(
        () => _i11.PartenaireService(gh<_i8.UserProvider>()));
    return this;
  }
}
